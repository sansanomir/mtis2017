 ...
 */
        ...
        */
        ...
        ServicioSkeletonInterface skel = (ServicioSkeletonInterface)obj;
        //Out Envelop
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("validarNIF".equals(methodName)){
                ...
                org.example.www.servicio.ValidarNIFResponse validarNIFResponse7 = null;
	                        org.example.www.servicio.ValidarNIF wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), validarNIFResponse7, false, new javax.xml.namespace.QName("http://www.example.org/servicio/",
                                                    "validarNIF"));
