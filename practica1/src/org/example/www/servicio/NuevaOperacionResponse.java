 ...
 */
            ...
            /**
            *  NuevaOperacionResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NuevaOperacionResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.example.org/servicio/",
                "NuevaOperacionResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NuevaOperacionResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NuevaOperacionResponse",
    ...
    public static class Factory{
        ...
        */
        public static NuevaOperacionResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NuevaOperacionResponse object =
                new NuevaOperacionResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NuevaOperacionResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NuevaOperacionResponse)org.example.www.servicio.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
