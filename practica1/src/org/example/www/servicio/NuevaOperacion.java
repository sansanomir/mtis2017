 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":NuevaOperacion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "NuevaOperacion",
    ...
    public static class Factory{
        ...
        */
        public static NuevaOperacion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NuevaOperacion object =
                new NuevaOperacion();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NuevaOperacion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NuevaOperacion)org.example.www.servicio.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
